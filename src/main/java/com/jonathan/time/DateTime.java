 ...
 * Simple representation of Date and Time which provides simple formatting
 */
public class DateTime {
    ...
    static {
        ...
        dateTimeFormatPatternString = "yyyy-MM-dd HH:mm";
     ...
     */
    @NotNull
    private static String getFormattedLocalDateTime(LocalDateTime localDateTime) {
     ...
     */
    private static String getDateTimeFormatPatternString() {
